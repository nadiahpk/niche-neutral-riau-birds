...
# get island- and niche-specific parameter values
# ---
...
# number of nices
KV = [ params['K_' + island_name] for island_name in island_names ]

# generations since island separated
TV = [T]*H

# theta per niche
thetakV = [theta_k]*K

# construct J[k][h] float
...
for k in range(K):
    ...
    for island_name in island_names:
        ...
        Jkh = params['J_' + str(k) + '_' + island_name]
        Jk.append(Jkh)
...
if not os.path.isfile(fname):
    ...
    column_names += [ 'no_spp_' + island_name for island_name in island_names ]
