...
dir_results <- '../../results/cooccurrence_neutral_data_fitm/'
...
# loop over samples and calculate c-score
# ---
...
for (sample_ID in sample_IDs) {
    ...
    if (plot_histogram) {
        ...
        fname_hist <- paste(
                            c(dir_results, 'sim9_c_score_', subset_name, '_sample_ID_', sample_ID, '.pdf'), 
                            collapse = '')
        pdf(fname_hist)
