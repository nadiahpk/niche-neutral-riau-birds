...
no_samples = 1 # number of samples to draw using the spp generator NOTE change later to 1000
...
if not os.path.isfile(fname):
    ...
    # write column names 
    column_names  = [ 'sample_ID', 'S', 'H', 'K', 'theta' ]
    column_names += [ 'T_' + island_name for island_name in island_names ]
