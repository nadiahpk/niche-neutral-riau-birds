...
#sample_IDs <- 4:40       # which sample_IDs to do
sample_IDs <- 41:100       # which sample_IDs to do
...
dir_samples <- '../../results/neutral_data_fitm/'

# where to put results
dir_results <- '../../results/nestedness_rowpack_neutral_data_fitm/'
...
# get all the samples
fname_samples <- paste( 
                  c(dir_samples, 'samples_', subset_name, '_rho_', rho, '.csv'), 
                  collapse = '' )
