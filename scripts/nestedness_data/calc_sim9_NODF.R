...
dir_results <- '../../results/nestedness_data/'
...
obs_NODF <- df_NODFs[df_NODFs$subset_name == subset_name,]$NODF # the observe C-score for this subset


# obtain a randomised sample of C-Scores that exceeds the desired effective sample size
# ---

# NOTE using the burnt-in matrix from co-occurrence analysis
